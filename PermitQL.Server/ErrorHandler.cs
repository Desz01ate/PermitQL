...
{
    public static (string Message, string Type, int StatusCode) Classify(Exception ex, RuleSet ruleSet) => ex switch
    {
        ...
        _ => (ruleSet.ExposeDetailedErrors ? ex.Message : "Internal server error", "internal_error", 500),
    };
}